      ...
      <main className="min-h-screen bg-[#090D16] text-white py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="bg-[#121826] border border-[#1E293B] rounded-3xl p-8 text-center space-y-3">
            ...
            <span className="text-xs font-semibold uppercase tracking-widest text-[#b8a468]">Service Expert Gratuit</span>
            <h1 className="font-serif text-3xl font-bold text-white">Estimation à Distance par Photo</h1>
            <p className="text-xs text-[#94A3B8]">
              Vous possédez des bijoux, des pièces ou des objets anciens en métal précieux ? Transmettez-nous vos photos pour une première évaluation sous 24h ouvrées.
            </p>
          </div>
          ...
          <div className="bg-[#121826] border border-[#1E293B] rounded-3xl p-8 shadow-2xl">
            {submitted ? (
              <div className="py-12 text-center space-y-4">
                ...
                <h3 className="font-serif text-2xl font-bold text-white">Demande d'estimation enregistrée !</h3>
                <p className="text-sm text-[#94A3B8]">
                  Nos experts numismates et spécialistes en métaux préceux étudient vos éléments. Une proposition d'estimation détaillée vous sera envoyée par e-mail.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5 text-xs">
                ...
                <div>
                  <label className="block text-[#94A3B8] mb-1 font-medium">Description des biens à estimer</label>
                  <textarea
                    rows={3}
                    placeholder="Indiquez les poinçons visibles, gravures, dates ou poids..."
                    className="w-full bg-[#090D16] border border-[#1E293B] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#b8a468]"
                  />
                </div>
                ...
                <div className="border-2 border-dashed border-[#1E293B] hover:border-[#b8a468] rounded-2xl p-6 text-center cursor-pointer transition-colors bg-[#090D16]/50">
                  ...
                  <p className="font-semibold text-white">Glissez-déposez vos photos ici</p>
                  <p className="text-[11px] text-[#94A3B8] mt-1">Formats acceptés: JPG, PNG, WEBP (Max 10 Mo)</p>
                </div>
                ...
                >
                  Envoyer mes photos pour estimation
                </button>
              </form>
            )}
          </div>
